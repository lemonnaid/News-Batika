...
def get_similar_news(news_id):
    ...
    tfidf_vectorizer = TfidfVectorizer(max_df=0.95, min_df=2, stop_words=list(all_stop_words))
    ...
    similarities = cosine_similarity(normalized_features, current_article.reshape(1, -1))
